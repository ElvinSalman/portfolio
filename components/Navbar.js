...
export default function Navbar() {
  ...
  return (
    <nav className="relative max-w-6xl mx-auto px-4 py-6 md:py-10">
      ...
      <div className="hidden md900:flex justify-between items-center">
        ...
        <div className="flex space-x-8">
          {navLinks.map((page) => (
            <Link
              key={page}
              href={`/${i18n.language}/${page}`}
              className={`text-base ${router.asPath === `/${i18n.language}/${page}`
        ...
        <div className="flex items-center space-x-4">
          ...
          <a
            ...
            className="text-gray-600 dark:text-gray-300 hover:text-pink-500 dark:hover:text-pink-500 transition-colors duration-200"
          >
            <svg
          ...
          <a
            ...
            className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-600 transition-colors duration-200"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
          ...
          <a
            ...
            className="text-gray-600 dark:text-gray-300 hover:text-sky-600 dark:hover:text-sky-600 transition-colors duration-200"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
      ...
      >
        <div
          className={`fixed top-0 right-0 w-3/4 max-w-xs h-full bg-white dark:bg-gray-900 p-6 flex flex-col space-y-6 transform transition-transform duration-300 ${mobileOpen ? "translate-x-0" : "translate-x-full"
            }`}
          ...
          <div className="flex flex-col space-y-4">
            {navLinks.map((page) => (
              <Link
                key={page}
                href={`/${i18n.language}/${page}`}
                className={`text-lg ${router.asPath === `/${i18n.language}/${page}`
                  ? "text-gray-800 font-bold dark:text-gray-400"
